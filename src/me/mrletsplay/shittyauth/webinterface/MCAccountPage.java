    ...
    public MCAccountPage() {
        ...
        s.dynamic(els -> {
            ...
            els.add(WebinterfaceButton.builder()
                    ...
                    .onClick(new SendJSAction("shittyauth", "setSkinType", new ElementValue(skinTypeSel))
                            .onSuccess(ShowToastAction.info("Updated!")))
                    .create());
        });
        ...
        s.dynamic(() -> {
            ...
            return WebinterfaceCheckBox.builder()
                    ...
                    .onChange(ch -> new SendJSAction("shittyauth", "setEnableCape", new CheckboxValue(ch))
                            .onSuccess(ShowToastAction.info("Updated!")))
                    .create();
        });
