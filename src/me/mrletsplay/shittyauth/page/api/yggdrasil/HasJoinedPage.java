...
public class HasJoinedPage implements HttpDocument {
    ...
    public void createContent() {
        ...
        WebinterfaceAccount acc = Webinterface.getAccountStorage().getAccountByConnectionSpecificID(PasswordAuth.ID,
                ctx.getClientHeader().getPath().getQueryParameterValue("username"));
